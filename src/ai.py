...
class Minimax(object):
    ...
    def Start(self, depth):
        ...
        for squares in self.board.squares:
    ...
    def GetMoves(self, piece, position):
        ...
        moves, captures = self.board.GetAllowedMoves(piece, True)
        for pos in captures:
            if self.board.squares[pos.x][pos.y].piece != None:
                bestMoves.append([10 * self.board.squares[pos.x][pos.y].piece.value - piece.value, piece, pos])
